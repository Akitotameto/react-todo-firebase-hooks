...
type Props = {
    ...
    pageEdit: (id: number) => void,
    onFavorite: (id: number) => void,
    onUnFavorite: (id: number) => void,
    onDeleteLow: (id: number) => void
}

export const TodoDataLow: React.FC<Props> = ({todoData,onFavorite,onUnFavorite,onDeleteLow,pageEdit}) =>
{
    ...
    return(
        <tr key={id}>
            ...
            <td>
                ...
                <button onClick={() => pageEdit(id)}> 編集 </button>
            </td>
        </tr>
    )
}